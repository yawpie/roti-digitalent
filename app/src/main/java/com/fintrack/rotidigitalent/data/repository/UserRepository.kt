...
@Singleton
class UserRepository @Inject constructor( private val dbHelper: UserDatabaseHelper, private val sessionManager: SessionManager) {
...
//            val token = sessionManager.tokenFlow.first()
    ...
    suspend  fun setLastKnownLocation(context: Context, lat: Float,lon: Float): Result<Boolean> {
        return try {
